...
#[derive(Debug)]
pub struct EtherShiftProcessor {
    verbose: bool,
    processed_count: usize,
}

impl EtherShiftProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting EtherShift processing");
    
    let mut processor = EtherShiftProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = EtherShiftProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = EtherShiftProcessor::new(false);
